...
def unmerge_device_profiles(conn, profile_id: str, atomic_id: str) -> dict:
    ...
    try:
        ...
        conn.execute(
            ...
            (
                new_profile['id'],
                str(new_profile['atomic_devices_ids']),
        ...
        conn.execute(
            '''UPDATE device_profiles 
               ...
               WHERE id = ?''',
            (
                str(updated_profile['atomic_devices_ids']),
                updated_profile['attributes'],
                updated_profile['specificity'],
                updated_profile['model'],
                updated_profile['manufacturer'],
                updated_profile['origins'],
