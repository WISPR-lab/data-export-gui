...
export default {
  ...
  methods: {
    ...
    buildSavedGraph: function (savedGraph) {
      ...
      BrowserDB.getSavedGraph(this.sketch.id, graphId)
        .then((response) => {
    ...
    buildGraph: function (graphPlugin, refresh = false) {
      ...
      BrowserDB.generateGraphFromPlugin(this.sketch.id, this.currentGraph, currentIndices, timelineIds, refresh)
        .then((response) => {
    ...
    saveGraph: function () {
      ...
      BrowserDB.saveGraph(this.sketch.id, this.saveAsName, elements)
        .then((response) => {
