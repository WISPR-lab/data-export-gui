...
export default {
  ...
  methods: {
    ...
    async fetchStory() {
      BrowserDB.getStory(this.sketchId, this.storyId)
        .then((response) => {
    ...
    async save() {
      ...
      BrowserDB.updateStory(this.title, content, this.sketchId, this.storyId)
        .then((response) => {
    ...
    deleteStory() {
      ...
      BrowserDB.deleteStory(this.sketchId, this.storyId)
        .then((response) => {
          this.blocks = []

          BrowserDB.getStoryList(this.sketchId)
    ...
    async getSketchQuestions() {
      try {
        const response=await BrowserDB.getOrphanQuestions(this.sketch.id)
